...
/* harmony import */ var _components_input_mask__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./components/input-mask */ "./src/js/components/input-mask.js");
/* harmony import */ var _components_card_fill__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./components/card-fill */ "./src/js/components/card-fill.js");
/* harmony import */ var _components_card_fill__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_components_card_fill__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var _components_basket_note__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./components/basket-note */ "./src/js/components/basket-note.js");
/* harmony import */ var _components_basket_note__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_components_basket_note__WEBPACK_IMPORTED_MODULE_3__);
/* harmony import */ var _components_sort_gallery__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./components/sort-gallery */ "./src/js/components/sort-gallery.js");
/* harmony import */ var _components_sort_gallery__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(_components_sort_gallery__WEBPACK_IMPORTED_MODULE_4__);
/* harmony import */ var _components_info_text__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./components/info-text */ "./src/js/components/info-text.js");
/* harmony import */ var _components_info_text__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(_components_info_text__WEBPACK_IMPORTED_MODULE_5__);
/* harmony import */ var _components_to_basket__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./components/to-basket */ "./src/js/components/to-basket.js");
/* harmony import */ var _components_to_basket__WEBPACK_IMPORTED_MODULE_6___default = /*#__PURE__*/__webpack_require__.n(_components_to_basket__WEBPACK_IMPORTED_MODULE_6__);
...
/* harmony import */ var _components_counter__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./components/counter */ "./src/js/components/counter.js");
/* harmony import */ var _components_counter__WEBPACK_IMPORTED_MODULE_8___default = /*#__PURE__*/__webpack_require__.n(_components_counter__WEBPACK_IMPORTED_MODULE_8__);
/* harmony import */ var _components_basket_result_area__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./components/basket-result-area */ "./src/js/components/basket-result-area.js");
/* harmony import */ var _components_basket_result_area__WEBPACK_IMPORTED_MODULE_9___default = /*#__PURE__*/__webpack_require__.n(_components_basket_result_area__WEBPACK_IMPORTED_MODULE_9__);
/* harmony import */ var _components_product_modal__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./components/product-modal */ "./src/js/components/product-modal.js");
/* harmony import */ var _components_bottom_menu__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./components/bottom-menu */ "./src/js/components/bottom-menu.js");
/* harmony import */ var _components_bottom_menu__WEBPACK_IMPORTED_MODULE_11___default = /*#__PURE__*/__webpack_require__.n(_components_bottom_menu__WEBPACK_IMPORTED_MODULE_11__);
/* harmony import */ var _components_card_navigation__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./components/card-navigation */ "./src/js/components/card-navigation.js");
/* harmony import */ var _components_card_navigation__WEBPACK_IMPORTED_MODULE_12___default = /*#__PURE__*/__webpack_require__.n(_components_card_navigation__WEBPACK_IMPORTED_MODULE_12__);
...
/***/ "./src/js/components/basket-note.js":
/*!******************************************!*\
  !*** ./src/js/components/basket-note.js ***!
  \******************************************/
/***/ (() => {
...
function toggleBasketStatus() {
  var basketWrapper = document.querySelector('.basket__list');
  var basketTitle = document.querySelector('.basket__note');
  var basketSubtitle = basketTitle.querySelector('span');
...
/***/ "./src/js/components/basket-result-area.js":
/*!*************************************************!*\
  !*** ./src/js/components/basket-result-area.js ***!
  \*************************************************/
/***/ (() => {
...
function changeResult() {
  ...
  var resultPrice = document.querySelector('.basket__result-price');
  var resultAmount = document.querySelector('.basket__result-amount');
  var resultDeliveryPrice = document.querySelector('.basket__result-delivery');
  var resultDeliveryFree = document.querySelector('.basket__result-delivery-free');
  var resultTotalPrice = document.querySelector('.basket__result-right-price');
  var totalOfferPrice = document.querySelector('.basket__cost-text');
  var resultDiscount = document.querySelector('.basket__result-right--discount');
  ...
  basketItems.forEach(function (basketItem) {
    ...
    var basketItemSum = resultObj.amount * resultObj.price;
    resultPrice.innerText = +resultPrice.textContent + basketItemSum;
  });
  console.log(resultDiscount); // if (+resultPrice.innerText > 3000) {
...
/***/ "./src/js/components/bottom-menu.js":
/*!******************************************!*\
  !*** ./src/js/components/bottom-menu.js ***!
  \******************************************/
/***/ (() => {

var menuButton = document.querySelector('.small-nav__button--menu');
var basketButton = document.querySelector('.small-nav__button--basket');
var rightSide = document.querySelector('.right-aside');
var rightCloseButton = rightSide.querySelector('.right-aside__close');
var leftSide = document.querySelector('.left-aside');
var leftCloseButton = leftSide.querySelector('.left-aside__close');
...
/***/ "./src/js/components/card-fill.js":
/*!****************************************!*\
  !*** ./src/js/components/card-fill.js ***!
  \****************************************/
/***/ (() => {
...
window.addEventListener('click', function (e) {
  ...
  if (target.classList.contains('menu-card__link')) {
    var cardMini = target.closest('.menu-card'); // Карточка товара

    var card = document.querySelector('.card-item');
    var cardImage = card.querySelector('picture');
    var cardTitle = card.querySelector('.card-item__title');
    var cardInfo = card.querySelector('.card-item__info');
    var cardPrice = card.querySelector('.card-item__price');
    cardMiniObj = {
      ...
      createImgforAviWebp: function createImgforAviWebp() {
    ...
    card.dataset.id = "".concat(cardMiniObj.id);
    cardImage.innerHTML = "\n      <source srcset=\"".concat(cardMiniObj.cardImageAviWebp, "avif\" type=\"image/avif\">\n      <source srcset=\"").concat(cardMiniObj.cardImageAviWebp, "webp\" type=\"image/webp\">\n      <img class=\"card-item__image\" loading=\"lazy\" src=\"").concat(cardMiniObj.imgSource, "\" class=\"image\"\n      alt=\"").concat(cardMiniObj.title, "\">\n    ");
...
/***/ "./src/js/components/card-navigation.js":
/*!**********************************************!*\
  !*** ./src/js/components/card-navigation.js ***!
  \**********************************************/
/***/ (() => {

var cardNext = document.querySelector('.card__next');
var cardPrev = document.querySelector('.card__prev');
cardNext.addEventListener('click', function (e) {
  var target = e.target;
  var modalContainer = document.querySelector('.graph-modal__container');
  ...
  setTimeout(function () {
    ...
    if (currentCardItem.nextElementSibling) {
      ...
      var cardTitle = cardItem.querySelector('.card-item__title');
      var cardInfo = cardItem.querySelector('.card-item__info');
      var cardPrice = cardItem.querySelector('.card-item__price');
      nextCardObj = {
      ...
      cardItem.dataset.id = "".concat(nextCardObj.id);
      cardImage.innerHTML = "\n    <source srcset=\"".concat(nextCardObj.cardImageAviWebp, "avif\" type=\"image/avif\">\n    <source srcset=\"").concat(nextCardObj.cardImageAviWebp, "webp\" type=\"image/webp\">\n    <img class=\"card-item__image\" loading=\"lazy\" src=\"").concat(nextCardObj.imgSource, "\" class=\"image\"\n    alt=\"").concat(nextCardObj.title, "\">\n    ");
...
cardPrev.addEventListener('click', function (e) {
  var target = e.target;
  var modalContainer = document.querySelector('.graph-modal__container');
  modalContainer.classList.add('graph-modal__container--blink');
  var animationBlink = setTimeout(function () {
    ...
    if (currentCardItem.previousElementSibling) {
      ...
      cardItem.dataset.id = "".concat(prevCardObj.id);
      cardImage.innerHTML = "\n        <source srcset=\"".concat(prevCardObj.cardImageAviWebp, "avif\" type=\"image/avif\">\n        <source srcset=\"").concat(prevCardObj.cardImageAviWebp, "webp\" type=\"image/webp\">\n        <img class=\"card-item__image\" loading=\"lazy\" src=\"").concat(prevCardObj.imgSource, "\" class=\"image\"\n        alt=\"").concat(prevCardObj.title, "\">\n      ");
...
if (counter) {
  window.addEventListener('click', function (e) {
    ...
    if (target.classList.contains('counter__minus') || target.classList.contains('counter__plus')) {
      var counterWrapper = target.closest('.counter');
  ...
  function toggleBasketStatus() {
    var basketWrapper = document.querySelector('.basket__list');
    var basketTitle = document.querySelector('.basket__note-title');
    var basketSubtitle = document.querySelector('.basket__note-subtitle');
    var basketResult = document.querySelector('.basket__result');
...
/***/ "./src/js/components/info-text.js":
/*!****************************************!*\
  !*** ./src/js/components/info-text.js ***!
  \****************************************/
/***/ (() => {

var infoWrapper = document.querySelector('.info__content-wrapper');

if (infoWrapper) {
  var infoHeight = document.querySelector('.info__content').offsetHeight;
  var infoButton = document.querySelector('.info__more');
...
var footerMask = document.getElementById('footer-input');
var maskOptions = {
  mask: '+{996}(000)000-00-00',
  placeholderChar: '+{996}(000)000-00-00'
};
var mask = (0,imask__WEBPACK_IMPORTED_MODULE_0__["default"])(footerMask, maskOptions);
...
var swiper = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.hero-slider__wrapper', {
  speed: 400,
  spaceBetween: 100,
  pagination: {
...
var swiperMenu = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.menu-slider', {
  speed: 400,
  spaceBetween: 0,
  slidesPerView: 1,
  navigation: {
...
var swiperRecomendation = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.recomendation__slider', {
  speed: 400,
  spaceBetween: 20,
  slidesPerView: 2,
  navigation: {
...
/***/ "./src/js/components/sort-gallery.js":
/*!*******************************************!*\
  !*** ./src/js/components/sort-gallery.js ***!
  \*******************************************/
/***/ (() => {

var sortButton = document.querySelector('.gallery__sort-button');

if (sortButton) {
  var sortList = document.querySelector('.gallery__sort-list');
  ...
  document.addEventListener('click', function (e) {
    var target = e.target;
    var itsList = target == sortList || sortList.contains(target);
    var listButton = target == sortButton;
    var activeList = sortList.classList.contains('gallery__sort-list--active');
    console.log(target);
...
var sortButtonsWrapper = document.querySelector('.gallery__sort-list');
var galleryList = document.querySelector('.gallery__inner');

if (sortButtonsWrapper) {
  sortButtonsWrapper.addEventListener('click', function (e) {
    var target = e.target;

    if (target.dataset.sort === 'toExpensive') {
      for (var i = 0; i < galleryList.children.length; i++) {
        for (var j = 0; j < galleryList.children.length; j++) {
          var priceI = parseInt(galleryList.children[i].querySelector('.menu-card__price').textContent);
          var priceJ = parseInt(galleryList.children[j].querySelector('.menu-card__price').textContent);

          if (priceI < priceJ) {
            var replacedNode = galleryList.replaceChild(galleryList.children[j], galleryList.children[i]);
            galleryList.children[j].parentNode.insertBefore(replacedNode, galleryList.children[j]);
          }
        }
      }
    } else if (target.dataset.sort === 'toCheap') {
      for (var _i = 0; _i < galleryList.children.length; _i++) {
        for (var _j = 0; _j < galleryList.children.length; _j++) {
          var _priceI = parseInt(galleryList.children[_i].querySelector('.menu-card__price').textContent);

          var _priceJ = parseInt(galleryList.children[_j].querySelector('.menu-card__price').textContent);

          if (_priceI > _priceJ) {
            var _replacedNode = galleryList.replaceChild(galleryList.children[_j], galleryList.children[_i]);

            galleryList.children[_j].parentNode.insertBefore(_replacedNode, galleryList.children[_j]);
          }
        }
      }
    } else if (target.dataset.sort === 'toLarge') {
      for (var _i2 = 0; _i2 < galleryList.children.length; _i2++) {
        for (var _j2 = 0; _j2 < galleryList.children.length; _j2++) {
          var _priceI2 = parseInt(galleryList.children[_i2].querySelector('.menu-card__peaces').textContent);

          var _priceJ2 = parseInt(galleryList.children[_j2].querySelector('.menu-card__peaces').textContent);

          if (_priceI2 < _priceJ2) {
            var _replacedNode2 = galleryList.replaceChild(galleryList.children[_j2], galleryList.children[_i2]);

            galleryList.children[_j2].parentNode.insertBefore(_replacedNode2, galleryList.children[_j2]);
          }
        }
      }
    } else if (target.dataset.sort === 'toSmall') {
      for (var _i3 = 0; _i3 < galleryList.children.length; _i3++) {
        for (var _j3 = 0; _j3 < galleryList.children.length; _j3++) {
          var _priceI3 = parseInt(galleryList.children[_i3].querySelector('.menu-card__peaces').textContent);

          var _priceJ3 = parseInt(galleryList.children[_j3].querySelector('.menu-card__peaces').textContent);

          if (_priceI3 > _priceJ3) {
            var _replacedNode3 = galleryList.replaceChild(galleryList.children[_j3], galleryList.children[_i3]);

            galleryList.children[_j3].parentNode.insertBefore(_replacedNode3, galleryList.children[_j3]);
          }
        }
      }
    }
...
/***/ "./src/js/components/to-basket.js":
/*!****************************************!*\
  !*** ./src/js/components/to-basket.js ***!
  \****************************************/
/***/ (() => {
...
if (document.querySelector('.card')) {
  var cardButton = document.querySelector('.card-item__button');
  cardButton.addEventListener('click', function () {
    var cardItem = cardButton.closest('.card-item');
    var basketWrapper = document.querySelector('.basket__list');
    var cardCounter = document.querySelector('.counter__items'); // Получаем данные с карточки, создаем обьект
    ...
    var currentBasketItem = basketWrapper.querySelector("[data-id=\"".concat(cardInfo.cardId, "\""));

    if (currentBasketItem) {
      var currentCounter = currentBasketItem.querySelector('.counter__items');
      currentCounter.innerText = +currentCounter.innerText + cardInfo.cardCount;
    } else {
      console.log('111');
      basketWrapper.innerHTML += "\n      <article class=\"basket__order-mini order-mini\" data-id=\"".concat(cardInfo.cardId, "\">\n      <div class=\"order-mini__image\">\n        <picture>\n          <source srcset=\"").concat(cardInfo.cardImageAviWebp, "avif\" type=\"image/avif\">\n          <source srcset=\"").concat(cardInfo.cardImageAviWebp, "webp\" type=\"image/webp\">\n          <img loading=\"lazy\" src=\"").concat(cardInfo.cardImage, "\" class=\"image\" width=\"70\" height=\"47\"\n            alt=\"\u0444\u043E\u0442\u043E \u0431\u043B\u044E\u0434\u0430\">\n        </picture>\n      </div>\n      <h3 class=\"order-mini__title\">\n        ").concat(cardInfo.cardTitle, "\n      </h3>\n      <div class=\"order-mini__counter counter\">\n        <button class=\"counter__minus btn-reset\"></button>\n        <span class=\"counter__items\">\n          ").concat(cardInfo.cardCount, "\n        </span>\n        <button class=\"counter__plus btn-reset\"></button>\n      </div>\n      <div class=\"order-mini__cost\">\n        ").concat(cardInfo.cardPrice, " <span>\u0421\u041E\u041C</span>\n      </div>\n      </article>\n        ");
    }
